<template>
  <div class="min-h-[70vh] flex items-center justify-center px-4">
    <div class="w-full max-w-lg bg-white/90 dark:bg-slate-900/90 backdrop-blur rounded-xl shadow-lg p-6">
      <h2 class="text-2xl font-semibold text-slate-900 dark:text-slate-100 mb-4">Create an account</h2>
      ...
      <form @submit.prevent="signup" class="space-y-4" novalidate>
        ...
        <div class="flex items-center justify-end">
          <button type="submit" class="rounded-md bg-pink-500 hover:bg-pink-600 text-white px-4 py-2 font-medium focus:outline-none focus:ring-2 focus:ring-pink-300">Sign Up</button>
        </div>
      </form>
      ...
      <div class="grid gap-3">
        <button @click="googleSignUp" type="button" class="w-full rounded-md border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-2 flex items-center justify-center gap-2 hover:bg-slate-50 dark:hover:bg-slate-800/90 focus:outline-none focus:ring-2 focus:ring-pink-300 text-slate-700 dark:text-slate-200">
          ...
          <span class="text-sm text-slate-700 dark:text-slate-200">Sign up with Google</span>
        </button>

        <button @click="githubSignUp" type="button" class="w-full rounded-md border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-2 flex items-center justify-center gap-2 hover:bg-slate-50 dark:hover:bg-slate-800/90 focus:outline-none focus:ring-2 focus:ring-pink-300 text-slate-700 dark:text-slate-200">
          ...
          <span class="text-sm text-slate-700 dark:text-slate-200">Sign up with Github</span>
        </button>
      </div>
